    ...
    #define MOTOR_RIGHT_A_PIN_NO 20
    #define MOTOR_RIGHT_B_PIN_NO 19
   ...
   // #define ANALOG_WRITE_RESOLUTION         16    // Do NOT change
      #define ANALOG_WRITE_RESOLUTION         8     // 8-bit Do NOT change
