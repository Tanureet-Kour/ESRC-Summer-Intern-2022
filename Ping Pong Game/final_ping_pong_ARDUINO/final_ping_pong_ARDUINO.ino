...
//PLAYER_1_POT_LEFT
const int  left_potPin_player_1 = A0;    
//PLAYER_2_POT_RIGHT
const int  right_potPin_player_2 = A1;    
...
void setup() {
  Serial.begin(9600);  
  // SEVEN SEGMENT DISPLAY FOR PLAYER 1
  pinMode( A1 , OUTPUT );
  pinMode( B1 , OUTPUT );
  pinMode( C1 , OUTPUT );
  pinMode( D1 , OUTPUT );
  ...
  pinMode( F1 , OUTPUT );
  pinMode( G1 , OUTPUT );
  // SEVEN SEGMENT DISPLAY FOR PLAYER 2
  pinMode( A2 , OUTPUT );
  pinMode( B2 , OUTPUT );
  pinMode( C2 , OUTPUT );
  pinMode( D2 , OUTPUT );
...
void loop() {
  ...
  pot_right_player_2 = analogRead(right_potPin_player_2);
