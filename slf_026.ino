...
#define STANDARD_LEFT_MOTOR_SPEED   88
#define STANDARD_RIGHT_MOTOR_SPEED  80

#define OUTPUT_PID_MAX              1250.0
#define OUTPUT_PID_MIN             -1250.0

#define NUMBER_OF_ITERATIONS_PER_SECOND    50L
#define STOP_SIGN_MULTI_CHECK_SAMPLE_COUNT 100
...
const float Kp =   0.43;// PID constants
const float Kd =  13.0;
const int Ki =   0;

      float pTerm;
      float iTerm = 0; // Initialize
      float dTerm;
      float outputPID;

      float leftMotorSpeed, rightMotorSpeed; // Motor Speeds
...
void loop()
{
    ...
    {   
        ...
        if(reallyOnBlackBlock >= STOP_SIGN_MULTI_CHECK_SAMPLE_COUNT)
        {
            ...
            waitForSwitchPress(SWITCH_BOTTOM, PRINT);  
            iTerm = 0;
